...
public class DecoderTest {
    ...
    public void decoderTest() throws IOException, UnsupportedAudioFileException {
        ...
        try (Model model = new Model("assets/model");
            InputStream ais = AudioSystem.getAudioInputStream(new BufferedInputStream(new FileInputStream("assets/sounds/test.wav")));
